...
<body>
    ...
    <section class="home-section">
      ...
      <div id="view-panel">
          <?php 
              // Load admin_view_mem.php directly or fallback to memberlist.php
              if (file_exists('admin_view_mem.php')) {
                  include 'admin_view_mem.php';
              } elseif (file_exists('memberlist.php')) {
                  include 'memberlist.php';
              } else {
                  echo '<div class="alert alert-danger m-3">Error: No member view template found.</div>';
              }
          ?>
      </div>
